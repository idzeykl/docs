...
description: 'Узнайте о стандартных встроенных функциях в IdzeyKL'
---

# Встроенные функции

IdzeyKL предоставляет несколько встроенных функций, которые всегда доступны в ваших программах. Эти функции обеспечивают основные операции и удобные утилиты.
